  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8">
      <div className="flex items-end justify-between pt-8">
        <div>
          <h1 className="text-3xl font-bold text-primary tracking-tight">Requests</h1>
          <p className="text-sm text-muted mt-1">New leads and quote requests waiting to be handled</p>
        </div>
      </div>
      ...
      <div className="bg-card rounded-2xl border border-border-subtle p-12 text-center">
        <Inbox size={36} className="mx-auto text-muted/40 mb-3" />
        <p className="text-sm text-muted">No requests yet</p>
        <p className="text-[11px] text-muted/60 mt-1">Requests come in from your website, manual entry, or imports</p>
      </div>
    </div>
  );
}
